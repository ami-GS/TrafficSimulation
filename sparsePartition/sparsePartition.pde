...
//人間を動かす部分
  ...
  void checkSurround(){
    if(ycell != 0){
      if(subMAP[ycell-1][xcell] == 2){if(random(5000) < infectionY){setType(2);}}
      if(xcell != 0 && subMAP[ycell-1][xcell-1] == 2){if(random(5000) < infectionY){setType(2);}}
      if(xcell != 19 && subMAP[ycell-1][xcell+1] == 2){if(random(5000) < infectionY){setType(2);}}
    }
    if(ycell != 19){
      if(subMAP[ycell+1][xcell] == 2){if(random(5000) < infectionY){setType(2);}}
      if(xcell != 0 && subMAP[ycell+1][xcell-1] == 2){if(random(5000) < infectionY){setType(2);}}
